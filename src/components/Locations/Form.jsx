...
const Form = () => {
    ...
    return (
        <>
            ...
            <div className='hidden sm:flex w-full h-[60vh] bg-[#F7F6F4] items-start rounded-[5rem] relative z-50 max-w-[100%] flex-row justify-between px-28 py-16 3xl:h-[35vw] 4xl:h-[40vw]'>
            ...
            <div className='flex sm:hidden w-full bg-[#F7F6F4] rounded-3xl relative z-50 my-8 p-6'>
