...
const Cities = () => {
  ...
  return (
    <>
      ...
      <div className='hidden sm:flex w-full max-w-[80%] mx-auto h-auto flex-col items-center justify-center gap-20 py-20 3xl:h-[120vw] 3xl:mb-48 3xl:mt-36'>
        ...
        <div className='w-full flex flex-col justify-center items-center gap-10'>
          <div className='w-full bg-white rounded-[2.5rem] border-b-[1rem] border-[#b8dbef] p-0 h-[200px] 3xl:h-[30vw] flex justify-between items-center'>
