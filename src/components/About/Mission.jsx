...
const Mission = () => {
    return (
        <>
            ...
            <div className='hidden sm:flex w-full h-[180vw] bg-[#efece9] relative top-[-5vw] flex-col justify-center items-center gap-[25vw]'>
                ...
                <img src="/About curved.png" alt="curved-path" className='absolute inset-0 w-full h-full object-contain top-[60vw] z-0' />
