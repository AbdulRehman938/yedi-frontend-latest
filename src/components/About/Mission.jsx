...
const Mission = () => {
    return (
        <>
            ...
            <div className='hidden sm:flex w-full h-[180vw] sm:h-[180vw] bg-[#efece9] relative top-[-5vw] sm:top-[-5vw] flex-col justify-center items-center gap-[25vw] sm:gap-[25vw] 3xl:top-[-5vw] 3xl:h-[150vw] 4xl:top-[-10vw]'>
                <div id='child1' className='h-[60%] sm:h-[60%] w-[70%] sm:w-[70%] flex flex-col bg-transparent justify-center items-start text-left gap-20 sm:gap-20 relative z-10'>
                ...
                <img src="/About curved.png" alt="curved-path" className='absolute inset-0 w-full h-full object-contain top-[60vw] sm:top-[60vw] z-0 3xl:top-[45vw]' />
            ...
            {/* Small mobile screens (below 360px) */}
            <div className='flex xss:hidden sm:hidden w-full h-[480vw] bg-[#efece9] relative flex-col items-center justify-start px-4 py-8 pt-20 gap-8 mt-[-16vw]'>
                {/* Background Image - Behind mobile content */}
                <img src="/About curved mobile.png" alt="curved-path" className='absolute inset-0 w-full h-full object-contain top-[100vw] z-0' />
            ...
            {/* XSS mobile screens (360px to 639px) */}
            <div className='hidden xss:flex sm:hidden w-full h-[550vw] bg-[#efece9] relative flex-col items-center justify-start px-4 py-8 pt-20 gap-8 mt-[-16vw]'>
                {/* Background Image - Behind mobile content */}
                <img src="/About curved mobile.png" alt="curved-path" className='absolute inset-0 w-full h-full object-contain top-[200vw] z-0' />
