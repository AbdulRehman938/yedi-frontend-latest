  ...
  "
        ...
        >
          ...
          <motion.img
            ...
            alt="mirror mobile"
            className="mirror-svg-mobile w-full h-full z-30 xs:z-30 sm:z-30 object-cover absolute lg:hidden xss:mt-[-5rem] xs:mt-[-8rem]"
            variants={fadeVariant}
            initial="hidden"
            whileInView="visible"
            exit="exit"
      ...
      top-[20rem] 2xl:top-[-40rem] xl:top-[-10rem] lg:top-[-42rem] md:top-[-12rem] sm:top-[-10rem] 3xl:w-[120vw]"
          ...
          >
            <div className="w-full md:w-1/2 flex flex-col gap-4 text-center md:text-left px-2 2xl:w-[40%] xl:mr-[5rem] xl:mt-[-8rem] lg:mt-[-5rem] 3xl:mr-[8rem] xss:w-[100vw]">
              <h1 className="2xl:text-6xl lg:text-5xl md:text-4xl sm:text-3xl  text-primary font-bold xs:text-3xl xss:text-4xl">
