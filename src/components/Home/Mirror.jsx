...
const Mirror = () => {
  ...
  return (
    <div className="w-full bg-secondary h-[347vh] mt-[30rem] flex flex-col items-center relative overflow-visible">
      <div className="w-full relative flex flex-col items-center px-4 sm:px-6 overflow-visible">
        ...
        <div id="second" className="w-[100vw] h-[225vh] relative z-20 flex-col overflow-visible mt-[20rem] hidden sm:block">
          ...
          {/* Section 2 */}
          <motion.div
            className="relative top-[-5rem] z-30 w-full flex items-center justify-between gap-10 py-24"
            variants={fadeVariant}
            initial="hidden"
            whileInView="visible"
            exit="exit"
          ...
          {/* Section 3 */}
          <motion.div
            className="relative top-[-5rem] z-30 w-full flex items-center justify-between gap-10 py-24 mt-[-5rem]"
            variants={fadeVariant}
            initial="hidden"
            whileInView="visible"
            exit="exit"
