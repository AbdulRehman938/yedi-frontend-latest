...
const Mirror = () => {
  ...
  return (
    <>
      {/* Desktop version */}
      <div className="hidden sm:flex w-full bg-secondary flex-col items-center relative pt-56 overflow-visible 2xl:mt-[30rem] 2xl:h-[150vw] lg:mt-[30rem] lg:pt-[10rem] 3xl:mt-[25rem] 3xl:h-[148vw] lg:h-[190vh] xl:h-[157vw] xl:mt-[15rem] lg-xl:h-[300vh]">
  ...
  "
      ...
      top-[-20rem] 2xl:top-[-40rem] xl:top-[-10rem] lg:top-[-42rem] md:top-[-12rem] sm:top-[-10rem] 3xl:w-[120vw]"
            ...
            <motion.div
              ...
              viewport={{ once: false, amount: 0.2 }}
            >
              <div className="w-full md:w-1/2 flex flex-col gap-10 text-center md:text-left px-2 xl:ml-[8rem] xl:mt-[-1rem] lg:ml-[5rem] 2xl:ml-[10rem] 2xl:mt-[2rem] lg:mt-[2rem] 3xl:ml-[15rem] 3xl:mt-[-4rem] lg-xl:mt-[4rem] 4xl:mt-[-2rem]">
            ...
            <motion.div
              ...
              viewport={{ once: false, amount: 0.2 }}
            >
              <div className="w-full md:w-1/2 flex flex-col gap-10 text-center md:text-left px-2 2xl:w-[40%] xl:mr-[-5rem] xl:mt-[1rem] lg:mt-[2rem] lg:mr-[-6rem] 3xl:mr-[-2rem] 3xl:mt-[1vw] 4xl:mt-[5rem]">
