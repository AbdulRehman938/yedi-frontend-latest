...
const Mirror = () => {
  ...
  return (
    <div className="w-full bg-secondary mt-[10rem] flex flex-col items-center relative pt-56 overflow-visible md:mt-[20rem] 2xl:mt-[30rem] lg:mt-[15rem] xl:mt-[15rem] lg:pt-[10rem] 3xl:mt-[40rem]">
      <div className="w-full relative flex flex-col items-center px-4 sm:px-6 lg:px-8 overflow-visible">
        ...
        <motion.div
          id="mirror"
          className="w-[95%] sm:w-[90%] md:w-[85%] lg:w-[95%] xl:w-[85%] xl:ml-[10rem] 2xl:w-[95%] max-w-[1440px] z-30 2xl:mt-[-20rem] hidden sm:block
      ...
      <div className="sm:hidden w-full bg-secondary h-[124rem]">
        ...
        <div className="flex flex-col items-center justify-start w-full px-4 text-center pt-4 max-w-screen-sm mx-auto min-h-[200vh] pb-16 relative z-40">
          <motion.img
            ...
            className="
            mirror1-img 
            w-full h-auto object-contain inset-0 z-10 absolute top-[-25rem]
          "
            style={mobileStyle}
            variants={fadeVariant}
            initial="hidden"
          ...
          <div id="second" className="w-[100vw] relative z-30 h-[100rem] flex flex-col overflow-visible mt-[20rem] sm:hidden">
            <div className="absolute z-10 top-[-30rem] w-full h-[10rem] flex flex-col items-center -space-y-[80px] md:hidden">
              ...
              <img src="/brownmobile1.svg" alt="Mirror part 1" className="brownmobile1 w-full max-h-[30rem] mt-[80rem] relative top-[2rem] object-cover" />
              <img src="/brownmobile2.svg" alt="Mirror part 2" className="brownmobile2 w-full max-h-[30rem] mt-[60rem] relative top-[25rem] object-cover" />
              <img src="/brownmobile3.svg" alt="Mirror part 3" className="brownmobile3 w-full max-h-[30rem] mt-[60rem] relative top-[30rem] object-cover" />
            </div>
            ...
            <motion.div
              ...
              viewport={{ once: false, amount: 0.2 }}
            >
              <div className="w-[100vw] flex flex-col gap-4 text-center px-2 ml-[-9rem]">
              ...
              <div className="w-full flex justify-center ml-[-9rem] mt-[1rem]">
            ...
            {/* Section 2 */}
            <motion.div
              className="relative z-30 w-full flex flex-col items-center justify-between gap-10 py-24"
              variants={fadeVariant}
              initial="hidden"
              whileInView="visible"
              exit="exit"
              viewport={{ once: false, amount: 0.2 }}
            >
              <div className="w-full flex flex-col gap-4 text-center px-2 ml-[2rem] mt-[5rem]">
                <h1 className="text-primary text-4xl w-[95%] font-bold">
                  A tiny ask shouldn't feel so big.
                </h1>
                <p className="text-gray-500 text-lg w-[90vw] font-medium">
                  Waiting in line, holding it in, just to <span className="text-black font-medium">beg </span>
                  for a restroom key. It's awkward. I don't
                  want to tell someone I have to evacuate my bowels.
                </p>
              </div>
              <div className="w-full flex justify-center mt-[2rem]">
                <img src="/Home-character3.svg" alt="char3" className="w-[55%] max-w-md" />
              </div>
            </motion.div>

            {/* Section 3 */}
            <motion.div
              className="relative z-30 w-full flex flex-col items-center justify-between gap-10 mt-[-2rem]"
              variants={fadeVariant}
              initial="hidden"
              whileInView="visible"
              exit="exit"
            ...
            >
              <div className="w-full flex flex-col gap-4 text-center px-2">
                ...
                <p className="text-gray-500 text-base w-[80%] ml-[2rem] font-medium">
                  With Yedi, it's easy—go straight in and find the bathroom door,
                  scan and unlock to find <span className="text-black font-medium">relief</span>.
                </p>
              </div>
              <div className="w-full flex justify-center mt-[2rem]">
                <img src="/Home-character4.svg" alt="char4" className="w-[55%] max-w-md" />
              </div>
            </motion.div>
