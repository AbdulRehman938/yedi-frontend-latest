...
const Mirror = () => {
  ...
  return (
    <>
      {/* Desktop version */}
      <div className="hidden sm:block w-full bg-secondary 3xl:h-[210vh] xl:h-[332vh] lg:h-[240vh] flex-col items-center relative pt-56 overflow-visible 2xl:mt-[30rem] lg:mt-[30rem] lg:pt-[10rem] 3xl:mt-[40rem]">
