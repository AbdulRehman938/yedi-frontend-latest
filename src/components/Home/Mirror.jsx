...
const Mirror = () => {
  ...
  return (
    <>
      {/* Desktop version */}
      <div className="hidden sm:block w-full bg-secondary 3xl:h-[210vh] xl:h-[300vh] lg:h-[240vh] flex-col items-center relative pt-56 overflow-visible 2xl:mt-[30rem] lg:mt-[30rem] lg:pt-[10rem] 3xl:mt-[40rem]">
  ...
  "
          ...
          {/* Sections */}
          <div id="second" className="w-[100vw] h-[175vh] relative z-20 flex flex-col overflow-visible lg:top-[-6rem] mt-[15rem] lg:mt-[23rem] 2xl:mt-[15rem] xl:mt-[-10rem] 3xl:mt-[15rem] ">
      ...
      top-[-20rem] 2xl:top-[-40rem] xl:top-[-10rem] lg:top-[-42rem] md:top-[-12rem] sm:top-[-10rem] 3xl:w-[120vw]"
            ...
            <motion.div
              ...
              viewport={{ once: false, amount: 0.2 }}
            >
              <div className="w-full md:w-1/2 flex flex-col gap-4 text-center md:text-left px-2 xl:ml-[8rem] lg:ml-[5rem] 2xl:ml-[10rem] 2xl:mt-[1rem] lg:mt-[1rem] xl:mt-[3rem] 3xl:ml-[15rem] 3xl:mt-[-5rem] ">
            ...
            <motion.div
              ...
              viewport={{ once: false, amount: 0.2 }}
            >
              <div className="w-full md:w-1/2 flex flex-col gap-4 text-center md:text-left px-2 2xl:w-[40%] xl:mr-[5rem] xl:mt-[4rem] lg:mt-[1rem] 3xl:mr-[8rem]">
            ...
            {/* Section 3 */}
            <motion.div
              className="relative z-30 w-full flex flex-col md:flex-row items-center md:items-start justify-between gap-10 py-24 xl:mt-[-10rem] 2xl:mt-[-20rem] 2xl:px-[5rem] 3xl:mt-[-5rem] lg:mt-[-26rem] lg:pr-[5rem]"
              variants={fadeVariant}
              initial="hidden"
              whileInView="visible"
              exit="exit"
              viewport={{ once: false, amount: 0.2 }}
            >
              <div className="w-full md:w-1/2 flex flex-col gap-4 text-center md:text-left px-2 2xl:mt-[-10rem] lg:mt-[1rem] xl:mt-[-2rem] 3xl:ml-[10rem] lg:ml-[8rem] ">
