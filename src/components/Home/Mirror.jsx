...
const Mirror = () => {
  ...
  return (
    <>
      {/* Desktop version */}
      <div className="hidden sm:flex w-full bg-secondary flex-col items-center relative pt-56 overflow-visible 2xl:mt-[30rem] 2xl:h-[150vw] lg:mt-[30rem] lg:pt-[10rem] 3xl:mt-[50rem] 3xl:h-[145vw] lg:h-[190vh] xl:h-[157vw] xl:mt-[15rem] lg-xl:h-[300vh]">
