...
const Mirror = () => {
  ...
  lg:mt-[30rem] lg:pt-[10rem] lg:h-[129rem] 
  xl:mt-[30rem] xl:h-[200rem] 
  2xl:mt-[30rem] 
  3xl:mt-[40rem] 3xl:h-[150rem]">
  ...
  "
          ...
          {/* Sections */}
          <div id="second" className="w-[100vw] h-[175vh] relative z-20 flex flex-col overflow-visible lg:top-[12rem] mt-[18rem] lg:mt-[10rem] 2xl:mt-[20rem] xl:mt-[-5rem] 3xl:mt-[20rem] ">
      ...
      top-[-20rem] 2xl:top-[-40rem] xl:top-[-10rem] lg:top-[-42rem] md:top-[-12rem] sm:top-[-10rem] 3xl:w-[120vw]"
            ...
            {/* Section 1 */}
            <motion.div
              className="relative z-30 w-[80%] ml-28 flex flex-col md:flex-row items-center md:items-start justify-between gap-10 mt-[10rem] 3xl:mt-48 xs:ml-[3.5rem] xs:relative xs:top-[-30rem] xl:mt-[36rem]"
              variants={fadeVariant}
              initial="hidden"
              whileInView="visible"
              exit="exit"
              viewport={{ once: false, amount: 0.2 }}
            >
              <div className="w-full md:w-1/2 flex flex-col gap-4 text-center md:text-left px-2 xl:ml-[8rem] lg:ml-[5rem] 2xl:ml-[10rem] 2xl:mt-[1rem] lg:mt-[-6rem] xl:mt-[-1rem] 3xl:ml-[15rem] 3xl:mt-[-5rem] ">
            ...
            <motion.div
              ...
              viewport={{ once: false, amount: 0.2 }}
            >
              <div className="w-full md:w-1/2 flex flex-col gap-4 text-center md:text-left px-2 2xl:w-[40%] xl:mr-[5rem] xl:mt-[1rem] lg:mt-[3rem] lg:w-[40%] 3xl:mr-[8rem]">
            ...
            {/* Section 3 */}
            <motion.div
              className="relative z-30 w-full flex flex-col md:flex-row items-center md:items-start justify-between gap-10 py-24 xl:mt-[-1rem] 2xl:mt-[-20rem] 2xl:px-[5rem] 3xl:mt-[-5rem] lg:pr-[5rem]"
              variants={fadeVariant}
              initial="hidden"
              whileInView="visible"
              exit="exit"
              viewport={{ once: false, amount: 0.2 }}
            >
              <div className="w-full md:w-1/2 flex flex-col gap-4 text-center md:text-left px-2 3xl:mt-[10rem] xl:mt-[5.5rem] 3xl:ml-[10rem] lg:ml-[8rem] lg:mt-[-18rem]">
