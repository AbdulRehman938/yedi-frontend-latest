    ...
    <div className="w-full overflow-hidden bg-transparent min-h-screen">
      ...
      <div className="hidden sm:block relative w-full">
        <div className="w-full h-screen px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 3xl:px-20 pt-24 pb-0 grid grid-cols-12 gap-4 lg:gap-8 items-center">
          ...
          {/* Text right */}
          <AnimatedItem className="col-span-7 flex flex-col items-start justify-center z-10 pl-4 lg:pl-0 xl:mt-[-30rem] 3xl:ml-[13rem] 3xl:mb-[-15rem] 2xl:mt-[-50rem] 2xl:ml-[10rem] lg:mt-[-35rem] lg:ml-[6rem]  ">
