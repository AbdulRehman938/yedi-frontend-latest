...
const Locations = () => {
    ...
    return (
        <section className="w-full flex flex-col relative z-[1000] items-center pt-16 bg-gradient-to-b from-transparent to-[#f8fafc]">
            ...
            {/* ====== DESKTOP VIEW ====== */}
            <div className="hidden sm:flex flex-col h-[80rem] w-[100vw] ml-12 items-start mt-[30%] max-w-7xl pl-8 z-40 3xl:mt-[50%] 3xl:h-[100rem]">
            ...
            {/* ====== NEWSLETTER FORM ====== */}
            <div className="hidden sm:flex w-full bg-[#f7f6f4] h-[50vh] 3xl:h-[70vh] 3xl:bottom-[-5rem] rounded-[3rem] absolute bottom-[-8rem] left-0 right-0 z-[1100] mt-16 px-4 lg:px-8 py-12 flex-col lg:flex-row items-center justify-around gap-8 2xl:h-[65vh] 2xl:mb-10">
