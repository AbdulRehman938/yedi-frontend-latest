    ...
    return (
        <div className="w-full h-full p-6 bg-transparent">
            <div className="hidden sm:block">
                ...
                <div className='w-[100%] 3xl:h-[70vh] flex flex-col justify-around absolute z-[1100] rounded-[4rem] bottom-0 left-0 3xl:mt-[20rem] items-start py-5 bg-white overflow-hidden lg-xl:h-[100vh] '>
                    {/* Locations Section */}
                    <motion.div
